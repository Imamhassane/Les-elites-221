jQuery(document).ready(function(){
    ...
    jQuery("#amazingslider-1").amazingslider({
        ...
        lightboxtitlebottomcss:"{color:black; font-size:16px; font-family:robotol; overflow:hidden; text-align:left;}",
        arrowstyle:"always",
        ...
        textbgcss:"display:block; position:absolute; top:0px; left:0px; width:100%; height:100%; background-color:#000000; opacity:0.7; filter:alpha(opacity=70);",
        ...
        showfacebook:true,
        titlecss:"display:block; position:relative; font:bold 18px; color:#000000; white-space:nowrap;",
        ribbonimagey:0,
        ribbonimagex:0,
        ...
        transition:"slice,threedhorizontal,blinds",
        scalemode:"fill",
        isfullscreen:false,
        textformat: {
            "Center text": {
